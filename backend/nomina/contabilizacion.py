...
CUENTAS_NOMINA = {
    ...
    'aportes_arl':              ('237010', 'ARL por pagar'),
    'fondo_solidaridad':        ('237045', 'Fondo de solidaridad pensional'),
    'caja_comp_pagar':          ('237040', 'Caja compensación por pagar'),
    'icbf_pagar':               ('237050', 'ICBF por pagar'),
    'sena_pagar':               ('237055', 'SENA por pagar'),
